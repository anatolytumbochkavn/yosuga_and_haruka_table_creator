...
1. __Если вы скачивайте проект из вкладки _Releases_, то можете пропустить этот шаг.__ Создайте несколько папок со следующими именами: _excel_output_, _output_, _rpy_scenario_, _scenario_. Если вы выберете другие имена для папок, то программа выдаст ошибку.
